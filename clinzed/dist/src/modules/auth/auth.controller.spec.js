...
describe('AuthController', () => {
    ...
    beforeEach(async () => {
        ...
        }).overrideProvider(auth_service_1.AuthService).useValue(mockAuthService).compile();
        mockAuthcontroller = moduleRef.get(auth_controller_1.AuthController);
    });
    ...
    describe(('Function'), () => {
        ...
        const mockRes = (0, express_1.getMockRes)({ locals: {
                json: {},
                status: { status: '200' },
        ...
        describe(('Signup'), () => {
            ...
            test('should have mockSignUpUser to be instance of SignUpUserDto', async () => {
                const mockSignUpUser = new signup_dto_1.SignUpUserDto();
                expect(mockSignUpUser).toBeInstanceOf(signup_dto_1.SignUpUserDto);
            });
            test('should call mock authService', async () => {
                const mockSignUpUser = new signup_dto_1.SignUpUserDto();

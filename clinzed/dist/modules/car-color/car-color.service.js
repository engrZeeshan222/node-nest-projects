...
exports.CarColorService = void 0;
...
let CarColorService = class CarColorService {
    constructor(carColorRepository) {
    ...
    async findAll(queryParams, user) {
        try {
            const apiData = new apiFeatures_1.default(this.carColorRepository, queryParams);
    ...
    async remove(id) {
        try {
            ...
            carColor.status = enum_1.COMMON_STATUS.DELETED;
            carColor = await this.carColorRepository.save(Object.assign({}, carColor));
            return carColor;
        }
        catch (error) {
            throw new common_1.HttpException(error.message, error.status);
...
CarColorService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(car_color_entity_1.CarColor)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CarColorService);
exports.CarColorService = CarColorService;
//# sourceMappingURL=car-color.service.js.map